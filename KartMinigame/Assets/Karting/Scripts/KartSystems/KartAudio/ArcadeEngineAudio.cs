...
namespace KartGame.KartSystems
{
    ...
    public class ArcadeEngineAudio : MonoBehaviour
    {
        ...
        [Tooltip("Maximum Volume the Idle sound will be at")]
        [Range(0.1f, 1.0f)] public float IdleSoundMaxVolume = 0.5f;
        ...
        void Update()
        {
            ...
            IdleSound.volume    = Mathf.Lerp(0.6f * IdleSoundMaxVolume, 0.0f, kartSpeed * 4);
