...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:GridView HorizontalAlign="Center" Width="100%" ID="GridView1" runat="server" DataSourceID="EntityDataSource1" AutoGenerateColumns="False" CellPadding="0" DataKeyNames="ID" ForeColor="#333333" GridLines="None" PageSize="25" OnRowDataBound="GridView1_DataBound" ShowHeader="False">
    ...
    ContextTypeName="Masters" EntitySetName="projects" AutoGenerateOrderByClause="True" AutoGenerateWhereClause="False" EntityTypeFilter="project" 
    ViewStateMode="Enabled" EnableFlattening="False"
    Where="it.skills LIKE '%'+@Skill+'%'"  Select="">
        <WhereParameters>
